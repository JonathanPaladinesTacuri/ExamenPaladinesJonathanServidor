...
a persistence unit "ticketPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ticket\pom.xml":
...
artifact ("ticket.war") is already built. You can build
